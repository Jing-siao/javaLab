package extend;
//多個型態:Notebook,Product
public class Notebook extends Product {// 繼承父類別 建構方法不會繼承
//	public  void calc() {
//		//abstract抽象方法，子類別必須實作
//		//抽象類別不能產生物件 abstract class 不能new出物件
//	};
	public int warranty;// 保固天數

//	public Notebook(String name, int price, int warranty) {
//		super(name, price);// 呼叫父類別建構方法 子類別一定要有super且放第一行
//		//super();//沒有寫super會直接呼叫沒有參數的建構方法
//		//this.name = name;
//		//this.price = price;
//		// 子類別還是有父類別的屬性，只是不能直接使用
//		setName(name);
//		setPrice(price);
